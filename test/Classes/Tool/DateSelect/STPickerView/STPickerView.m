...
- (void)setLeftButtonTilteColor:(UIColor *)leftButtonTilteColor
{
    _leftButtonTilteColor = leftButtonTilteColor;
    [_buttonLeft setTitleColor:leftButtonTilteColor forState:UIControlStateNormal];
    
}
- (void)setRightButtonTilteColor:(UIColor *)rightButtonTilteColor
{
    _rightButtonTilteColor = rightButtonTilteColor;
    [_buttonRight setTitleColor:rightButtonTilteColor forState:UIControlStateNormal];
}
